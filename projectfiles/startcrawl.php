...
// If different, notify!
$purl=mysql_query("SELECT * FROM CRITERIA WHERE URL='".$url."' and USER='".$userRow['userName']."'",$conn);
$pRow=mysql_fetch_array($purl);
...
{$duplicatec=mysql_fetch_array(mysql_query("SELECT ID FROM childurls where childurl='$child'",$conn));
  if(!$duplicatec['ID'])
  {
